...
import GridCities from './component/GridCities';
import CreateCity from './component/CreateCity';
import CreateSite from './component/CreateSite';
import GridSites from './component/GridSites';
import CreateCompCategories from './component/CreateCompCategories';
import GridCompCategory from './component/GridCompCategory';
      ...
      <div>
        <Router>
          ...
          <div className="container">
            ...
            <Route path="/component/CreateBrand" component={CreateBrand} />

            <Route path="/component/GridCities" component={GridCities} />
            <Route path="/component/CreateCity" component={CreateCity} />

            <Route path="/component/GridSites" component={GridSites} />
            <Route path="/component/GridCompCategory" component={GridCompCategory} />
            <Route path="/component/CreateSite" component={CreateSite} />
            <Route path="/component/CreateCompCategories" component={CreateCompCategories} />
