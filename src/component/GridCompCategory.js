...
export class GridCompCategory extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    componentDidMount() {
        ...
        axios({
            method: 'get',
            url: Serverurl + "competitor_cat_show",
            data: data,
            headers: {
    ...
    deleteBooking() {
        ...
        axios({
            method: 'DELETE',
            url: Serverurl + 'competitor_cat_delete/' + id,
            data: data,
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
            },
                            ...
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <div className="list-head-btn">
                                        <div className="head">
                                            <h4>List Competitor Categories</h4>
                                        </div>
                                        <div class="button-align">
                                            <a href="/component/CreateCompCategories" type="button" class="btn btn-danger waves-effect waves-light submit-button" >Add Brands</a>
                                        </div>
                                    </div>
                                    <div class="table-3">
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="exampleModalLabel">Competitor Category Delete</h5>
                                    ...
                                    <div className="modal-body">
                                        <p>
                                            <strong>
                                                You're about to delete a Competitor Category from this page. Are you sure?
                                            </strong>
                                        </p>
                                    </div>
...
export default GridCompCategory
