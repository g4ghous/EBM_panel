...
export class CreateCompCategories extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    addCompCategory(e) {
        ...
        if (validation == true) {
            ...
            formData.append('cc_name', this.state.cc_name)
            ...
            if (this.state.name === "" ||
                ...
                axios({
                    method: 'post',
                    url: Serverurl + 'competitor_cat_add',
                    data: formData,
                    headers: {
                    ...
                    .then((res) => {
                        ...
                        if (res.status === "true") {
                            ...
                            swal("Competitor Category Succesfully Created!");
                        }
                        setTimeout(() => {
                        ...
                        <div class="parent">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <h4 class="mt-0 header-title">Add Competitor Category</h4>
                                    ...
                                    <div class="form-group row input-margin">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="cc_name" onChange={this.handleChangeBrands.bind(this)} type="text" id="example-text-input" />
                                        </div>
                                    </div>
                                    ...
                                    {/* <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <div class="button-align">
                                            <button type="button" class="btn btn-danger waves-effect waves-light submit-button" onClick={this.addCompCategory.bind(this)}>Submit</button>
                                        </div>
                                    </div>
...
export default CreateCompCategories
