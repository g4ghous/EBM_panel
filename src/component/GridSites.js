...
export class GridSites extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
                                ...
                                <div class="card-body table-responsive">
                                    <div className="list-head-btn">
                                        ...
                                        <div class="button-align">
                                            <a href="/component/CreateSite" type="button" class="btn btn-danger waves-effect waves-light submit-button" >Add Sites</a>
                                        </div>
                                    </div>
                                    <div class="table-3">
                                        <table id="datatable2" class="table">
                                            ...
                                            {this.state.data.map((disease) =>
                                                    <tr key={disease.id}>
                                                        <td>{disease.s_name}</td>
                                                        <td>{disease.c_name}</td>
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="exampleModalLabel">Site Delete</h5>
                                    ...
                                    <div className="modal-body">
                                        <p>
                                            <strong>
                                                You're about to delete a Site from this page. Are you sure?
                                            </strong>
                                        </p>
                                    </div>
