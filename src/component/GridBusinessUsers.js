                                    ...
                                    <div class="table-3">
                                        <table id="datatable2" class="table">
                                            ...
                                            {this.state.data.map((disease) =>
                                                    <tr key={disease.id}>
                                                        <td>{disease.user_type == "admin" ? disease.admin_show_id : disease.user_type == "manager" ? disease.manager_show_id : disease.user_type == "sales" ? disease.sales_show_id : "null"}</td>
                                                        <td>{disease.name}</td>
                                                        <td>{disease.email}</td>
                                                        <td>{disease.phone}</td>
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="exampleModalLabel">User Delete</h5>
