...
export class GridCities extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
                                ...
                                <div class="card-body table-responsive">
                                    <div className="list-head-btn">
                                        ...
                                        <div class="button-align">
                                            <a href="/component/CreateCity" type="button" class="btn btn-danger waves-effect waves-light submit-button" >Add Cities</a>
                                        </div>
                                    </div>
                                    <div class="table-3">
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="exampleModalLabel">City Delete</h5>
                                    ...
                                    <div className="modal-body">
                                        <p>
                                            <strong>
                                                You're about to delete a City from this page. Are you sure?
                                            </strong>
                                        </p>
                                    </div>
