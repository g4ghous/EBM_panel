...
export class CreateSite extends Component {
    ...
    componentDidMount(){
        ...
        axios({
            ...
            //     console.log("loop", res.data[i].s_);
    ...
    addBrand(e) {
        ...
        if (validation == true) {
            ...
            formData.append('s_name', this.state.s_name)
                ...
                axios({
                    ...
                    .then((res) => {
                        ...
                        if (res.status === "true") {
                            ...
                            swal("Site Succesfully Created!");
                        }
                        setTimeout(() => {
                            window.location.href = "/component/GridSites"
                        }, 3000)
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="form-group row input-margin">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="s_name" onChange={this.handleChangeBrands.bind(this)} type="text" id="example-text-input" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="city_id" class="form-control" onChange={this.handleChangeBrands.bind(this)}>
                                                    <option>Select City</option>
                                                    {this.state.cities.map((city) => {
                                                        return (
                                                            <option key={city.id} value={city.id}>{city.c_name}</option>
                                                        )
                                                    })}
                                                </select>
                                            </div>
